<div class="max-w-7xl mx-auto mt-10 py-6 px-4 sm:px-6 lg:px-8">
    ...
    <form action="" wire:submit.prevent="saveContent">
        ...
        <div class="mb-5">
            ...
            <input type="text" wire:model.defer="description" class="w-full @error('description') border-red-700 @enderror">
        ...
        <div class="mb-5 flex">
            <div class="w-1/3 h-96 flex items-center justify-center">
                <label class="block mr-10">Capa</label>
